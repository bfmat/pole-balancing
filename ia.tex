...
After implementation, testing, and empirical tweaking of the cost matrices $Q$ and $R$, I found that the resulting controller gain matrix $K$ was a very nearly optimal solution to the environment, bringing the pole to the center of the track very rapidly and with very minimal overshoot. Figures \ref{position}, \ref{angle}, and \ref{force} display this graphically.
